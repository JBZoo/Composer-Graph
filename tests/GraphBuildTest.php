...
class GraphBuildTest extends AbstractGraphTest
{
    ...
    public function testJBZooToolbox()
    {
        isSame(implode("\n", [
            ...
            '    jbzoo__composer_diff-->|"4.0.x-dev"|jbzoo__data;',
            '    jbzoo__composer_diff-->|"4.0.x-dev"|jbzoo__utils;',
            '    jbzoo__composer_diff-->|">=7.2"|PHP;',
            '    jbzoo__composer_diff-->|"^1.0||^2.0||^3.0"|composer__semver;',
            '    jbzoo__composer_diff-->|"^4.4||^5.0"|symfony__console;',
            '    jbzoo__composer_diff-->|"^4.4||^5.0"|symfony__process;',
            ...
            '    jbzoo__toolbox == "1.0.x-dev" ==> jbzoo__composer_diff;',
            ...
            '    phpspec__prophecy-->|"^1.2"|doctrine__instantiator;',
            '    phpspec__prophecy-->|"^3.0 || ^4.0"|sebastian__comparator;',
            '    phpspec__prophecy-->|"^3.0 || ^4.0"|sebastian__recursion_context;',
            '    phpspec__prophecy-->|"^5.0"|phpdocumentor__reflection_docblock;',
            '    phpspec__prophecy-->|"^7.2"|PHP;',
            ...
            '    webmozart__assert-->|"^5.3.3 || ^7.0 || ^8.0"|PHP;',
            ...
            '        jbzoo__composer_diff("jbzoo/composer-diff@1.0.x-dev");',
            ...
            '        phpspec__prophecy("phpspec/prophecy@1.11.1");',
            ...
            '        symfony__deprecation_contracts("symfony/deprecation-contracts@v2.1.3");',
            '        symfony__event_dispatcher("symfony/event-dispatcher@v4.4.10");',
            '        symfony__event_dispatcher_contracts("symfony/event-dispatcher-contracts@v1.1.9");',
            ...
            '        symfony__http_client_contracts("symfony/http-client-contracts@v2.1.3");',
            ...
            '        symfony__service_contracts("symfony/service-contracts@v2.1.3");',
            ...
            '        webmozart__assert("webmozart/assert@1.9.1");',
    ...
    public function testRealProject()
    {
        ...
        $composerJson = json(PROJECT_ROOT . '/tests/fixtures/' . __FUNCTION__ . '/composer.json');
        $composerLock = json(PROJECT_ROOT . '/tests/fixtures/' . __FUNCTION__ . '/composer.lock');
